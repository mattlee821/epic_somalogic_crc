...
# non-cancer
cd ${DATA}/non-cancer
Rscript ${SCRIPT} ${DATA}non-cancer/parameter_file_female.txt
mv ${IN}non-cancer/metaboprep* ${OUT}non-cancer/female/
mv ${DATA}non-cancer/figure/ ${OUT}non-cancer/female/
mv ${DATA}non-cancer/metaboprep* ${OUT}non-cancer/female/
