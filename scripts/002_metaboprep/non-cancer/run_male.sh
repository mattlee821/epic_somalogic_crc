...
# non-cancer
cd ${DATA}/non-cancer
Rscript ${SCRIPT} ${DATA}non-cancer/parameter_file_male.txt
mv ${IN}non-cancer/metaboprep* ${OUT}non-cancer/male/
mv ${DATA}non-cancer/figure/ ${OUT}non-cancer/male/
mv ${DATA}non-cancer/metaboprep* ${OUT}non-cancer/male/
