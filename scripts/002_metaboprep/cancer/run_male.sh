...
# cancer
cd ${DATA}/cancer
Rscript ${SCRIPT} ${DATA}cancer/parameter_file_male.txt
mv ${IN}cancer/metaboprep* ${OUT}cancer/male/
mv ${DATA}cancer/figure/ ${OUT}cancer/male/
mv ${DATA}cancer/metaboprep* ${OUT}cancer/male/
