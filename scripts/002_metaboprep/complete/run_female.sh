...
# complete
cd ${DATA}/complete
Rscript ${SCRIPT} ${DATA}complete/parameter_file_female.txt
mv ${IN}complete/metaboprep* ${OUT}complete/female/
mv ${DATA}complete/figure/ ${OUT}complete/female/
mv ${DATA}complete/metaboprep* ${OUT}complete/female/
