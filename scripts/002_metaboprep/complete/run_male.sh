...
# complete
cd ${DATA}/complete
Rscript ${SCRIPT} ${DATA}complete/parameter_file_male.txt
mv ${IN}complete/metaboprep* ${OUT}complete/male/
mv ${DATA}complete/figure/ ${OUT}complete/male/
mv ${DATA}complete/metaboprep* ${OUT}complete/male/
