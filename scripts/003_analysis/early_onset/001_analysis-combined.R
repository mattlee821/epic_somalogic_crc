...
# data ====
file_list <- list.files("analysis/002_outlier-exclusions/complete/combined/early_onset/", pattern = "phenofile", full.names = TRUE, recursive = TRUE)
...
for (files in file_list) {
  ...
  for (exposure in proteins)
  {
    ...
    ## model 2 full data median_above: sex, center, 5 year age group ====
    model2_median_above <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                   strata(sex, center, age_group) +
                                   cluster(idepic), 
                                 data = data_analysis_median_above)  
    
    ## model 2 excl2year median_above: sex, center, 5 year age group ====
    model2_median_above_excl2year <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                             strata(sex, center, age_group) +
                                             cluster(idepic), 
                                           data = data_analysis_median_above_excl2year)  
    
    ## model 2 full data median_below: sex, center, 5 year age group ====
    model2_median_below <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                   strata(sex, center, age_group) +
                                   cluster(idepic), 
                                 data = data_analysis_median_below)  
    
    ## model 2 excl2year median_below: sex, center, 5 year age group ====
    model2_median_below_excl2year <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                             strata(sex, center, age_group) +
                                             cluster(idepic), 
                                           data = data_analysis_median_below_excl2year)  
    
    ## model 3 full data: sex, center, 5 year age group, fasting, bmi, alcohol, smoking ====
    ...
    ## model 3 excl2year: sex, center, 5 year age group, fasting, bmi, alcohol, smoking ====
    ...
    ## model 3 full data median_above: sex, center, 5 year age group, fasting, bmi, alcohol, smoking ====
    ...
    ## model 3 excl2year median_above: sex, center, 5 year age group, fasting, bmi, alcohol, smoking ====
    ...
    ## model 3 full data median_below: sex, center, 5 year age group, fasting, bmi, alcohol, smoking ====
    ...
    ## model 3 excl2year median_below: sex, center, 5 year age group, fasting, bmi, alcohol, smoking ====
    ...
    ## model 4 full data: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education ====
    ...
    ## model 4 excl2year: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education ====
    ...
    ## model 4 full data median_above: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education ====
    ...
    ## model 4 excl2year median_above: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education ====
    ...
    ## model 4 full data median_below: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education ====
    ...
    ## model 4 excl2year median_below: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education ====
    ...
    ## model 5 full data: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre ====
    ...
    ## model 5 excl2year: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre ====
    model5_excl2year <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                fasting_c + 
                                cluster(idepic), 
                              data = data_analysis_excl2year) 
    
    ## model 5 full data median_above: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre, ====
    model5_median_above <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                   fasting_c + 
                                   cluster(idepic), 
                                 data = data_analysis_median_above)  
    
    ## model 5 excl2year median_above: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre ====
    model5_median_above_excl2year <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                             fasting_c + 
                                             cluster(idepic), 
                                           data = data_analysis_median_above_excl2year) 
    
    ## model 5 full data median_below: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre ====
    model5_median_below <- coxph(Surv(age, ageevent, indevent) ~  get(exposure) +
                                   fasting_c + 
                                   cluster(idepic), 
                                 data = data_analysis_median_below)  
    
    ## model 5 excl2year median_below: sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre ====
    ...
    table_model2$covariates <- "sex, center, 5 year age group"
    table_model3$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking"
    table_model4$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education"
    table_model5$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre"
    ...
    table_model2_excl2year$covariates <- "sex, center, 5 year age group"
    table_model3_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking"
    table_model4_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education"
    table_model5_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre"
    ...
    table_model2_median_above$covariates <- "sex, center, 5 year age group"
    table_model3_median_above$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking"
    table_model4_median_above$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education"
    table_model5_median_above$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre"
    ...
    table_model2_median_above_excl2year$covariates <- "sex, center, 5 year age group"
    table_model3_median_above_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking"
    table_model4_median_above_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education"
    table_model5_median_above_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre"
    ...
    table_model2_median_below$covariates <- "sex, center, 5 year age group"
    table_model3_median_below$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking"
    table_model4_median_below$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education"
    table_model5_median_below$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre"
    ...
    table_model2_median_below_excl2year$covariates <- "sex, center, 5 year age group"
    table_model3_median_below_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking"
    table_model4_median_below_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education"
    table_model5_median_below_excl2year$covariates <- "sex, center, 5 year age group, fasting, bmi, alcohol, smoking, physical activity, education, total energy, fat, fibre"
  }
